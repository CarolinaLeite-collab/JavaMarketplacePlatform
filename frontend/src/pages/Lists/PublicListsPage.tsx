...
import { Table, ActionIcon, Text, Loader, Center } from "@mantine/core";
        ...
        <DefaultLayout title="Public Lists" subtitle="CHECK OUT OTHER'S COLLECTIONS:">
            ...
            {loading ? (
                ...
                >
                    <Table.Thead>
                        <Table.Tr>
                            <Table.Th style={{ width: "50%", fontWeight: 500 }}>List name</Table.Th>
                            <Table.Th style={{ width: "30%", fontWeight: 500 }}>Genre</Table.Th>
                            <Table.Th style={{ width: "20%", textAlign: "center", fontWeight: 500 }}>Add to Favourites</Table.Th>
                        </Table.Tr>
                    </Table.Thead>
                    <Table.Tbody>
