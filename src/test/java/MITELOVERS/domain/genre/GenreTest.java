...
class GenreTest {
    ...
    @Test
    void constructorWithIdShouldBuildGenre() {
        // Arrange
        ...
        // Act
        GenreId resultId = _sut.identity();
    ...
    @Test
    void constructorWithIdShouldThrowWhenGenreIdIsNull() {
        // Arrange
        ...
        // Act
        Exception result = assertThrows(NullPointerException.class, () -> new Genre(genreId, "Mystery"));
    ...
    @Test
    void constructorWithIdShouldThrowWhenGenreIsNull() {
        // Arrange
        GenreId genreId = new GenreId("Mystery");
        String name = null;
        ...
        // Act
        Exception result = assertThrows(NullPointerException.class, () -> new Genre(genreId, name));
    ...
    @Test
    void constructorWithIdShouldThrowWhenGenreIsBlank() {
        // Arrange
        GenreId genreId = new GenreId("Mystery");
        String name = "  ";
        ...
        // Act
        Exception result = assertThrows(IllegalArgumentException.class, () -> new Genre(genreId, name));
