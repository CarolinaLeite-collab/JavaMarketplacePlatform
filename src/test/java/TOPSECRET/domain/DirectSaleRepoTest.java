...
class DirectSaleRepoTest {
   ...
   @Test
    ...
    void getDirectSaleItemsByPublicationShouldReturnItemsOfThatPublication() {
        ...
        repo.createDirectSale(_itemDouble1, mock(Price.class), null);
        repo.createDirectSale(_itemDouble2, mock(Price.class), null);

        List<Item> resultsList = repo.getDirectSaleItemsByPublication(_publicationDouble);
