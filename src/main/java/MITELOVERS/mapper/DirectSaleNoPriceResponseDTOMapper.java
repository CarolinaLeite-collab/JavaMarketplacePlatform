...
@Component
public class DirectSaleNoPriceResponseDTOMapper {

    public DirectSaleNoPriceResponseDTO toModel(DirectSale directSale) {

        return new DirectSaleNoPriceResponseDTO(
