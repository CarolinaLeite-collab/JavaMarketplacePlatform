...
public class Bid {
    ...
    private final User bidder; // Final: bidder cannot change
    private final Price offerPrice; // Final: offer price is immutable
    private final LocalDateTime bidDate; //Final: historical timestamp
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(bidder, bid.bidder) &&
                Objects.equals(offerPrice, bid.offerPrice) &&
                Objects.equals(bidDate, bid.bidDate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(bidder, offerPrice, bidDate);
    }
